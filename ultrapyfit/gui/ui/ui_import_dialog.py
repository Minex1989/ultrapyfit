...
#endif // QT_CONFIG(tooltip)
        self.TimeMetricComboBox.setItemText(0, QCoreApplication.translate("ImportDialog", u"Microsecond (\u00b5s)", None))
        self.TimeMetricComboBox.setItemText(1, QCoreApplication.translate("ImportDialog", u"Nanosecond (ns)", None))
