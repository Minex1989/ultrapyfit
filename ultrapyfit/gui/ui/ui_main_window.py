...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chkConvertToEAS.setText(QCoreApplication.translate("MainWindow", u"EAS (Sequential) Spectra", None))
        self.grpGlobalFitPlotSettings.setTitle("")
        self.lblGlobalKineticsSel.setText(QCoreApplication.translate("MainWindow", u"Wavelengths (nm):", None))
        self.grpGlobalReport.setTitle(QCoreApplication.translate("MainWindow", u"Global Fitting Results:", None))
        self.grpSingleFitSettings.setTitle(QCoreApplication.translate("MainWindow", u"Egyedi Kinetikai Illeszt\u00e9s", None))
        self.chkSingleDetails.setText(QCoreApplication.translate("MainWindow", u"Displaying Tau values on the graph", None))
